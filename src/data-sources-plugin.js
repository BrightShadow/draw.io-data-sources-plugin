/**
 * Sample plugin: sources taken from https://github.com/balvanra/draw.io-plugins, will be changed while I will start development.
 * Temporary I leave the code unchanged until I will start active development.
 */
